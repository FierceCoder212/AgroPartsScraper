...
class ScraperHelper:
    ...
    def scrape_data(self, location: str = '', model_data: list[str] = None):
            ...
            if 'entries' in json_response:
                ...
                for entry in entries:
                    if entry['linkType'] == 'MACHINE':
                        ...
                        self.scrape_data(new_location, current_model_data)

    def save_data(self):
        with open('ModelList.json', 'w') as json_file:
            json_file.write(json.dumps(self.model_list, indent=4))
    ...
    def _extract_model(self, model_data: list[str], location: str):
        ...
        self.model_list.append(json_model)
